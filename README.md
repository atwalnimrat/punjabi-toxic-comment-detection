...
You can create an API key by following the official documentation:
`https://developers.google.com/youtube/v3/getting-started`

> **Note**:
>`config.py` is intentionally not visible in the repository because it is listed in `.gitignore`.
